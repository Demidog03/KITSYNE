          ...
          <ul className={styles.cards} role="list">
            <li className={`${styles.card} ${styles.card1}`}>
              ...
              <p className={styles.text}>
                Engage with hands-on challenges and real projects that make learning fun and practical.
            ...
            <li className={`${styles.card} ${styles.card2}`}>
              ...
              <p className={styles.text}>
                Master core software development skills and gain real-world experience through teamwork
