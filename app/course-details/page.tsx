                ...
                <main className={styles.main}>
                    ...
                    <section className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            coding. You’ll learn wireframes, design UIs and build interactive prototypes step-by-step.
                        </p>
                    </section>
                    ...
                    <section className={styles.section}>
                        ...
                        <p className={styles.text}>
                            By the end you will create a clickable prototype, understand design handoff and prepare
                    ...
                    <section className={styles.sectionHead}>
                        ...
                        <div className={styles.controls}>
                            <button className={styles.ctrlBtn} aria-label="prev">‹</button>
