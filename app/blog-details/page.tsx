  ...
  return (
    <div>
      ...
      <div className={styles.container}>
        ...
        <nav className={styles.toc} aria-label="Table of contents">
          ...
          <ol>
            <li>
              <a href="#rise">The Rise of Declarative UI</a>
            </li>
            <li>
              <a href="#who">Who Should Learn SwiftUI?</a>
            </li>
            <li>
              <a href="#cases">Real-World Use Cases</a>
            </li>
            <li>
              <a href="#advantages">Key Advantages</a>
            </li>
            <li>
              <a href="#interop">Interoperability with UIKit</a>
            </li>
            <li>
              <a href="#state">State Management</a>
            </li>
            <li>
              <a href="#previews">Designing with Previews</a>
            </li>
            <li>
        ...
        <article className={styles.content}>
          <p>
            ...
            syntax and seamless integration with Apple’s ecosystem. Whether you’re building apps for
            iOS, macOS, watchOS or tvOS, SwiftUI allows you to create polished UIs with less code —
          ...
          <p>
            Finance, health, and retail already ship production apps with SwiftUI. Apple keeps
            adding SwiftUI-only APIs, nudging the community to adopt it for new projects.
          </p>
          ...
          <p>
            ...
            <code>UIViewControllerRepresentable</code> to embed legacy views, or host SwiftUI inside
            UIKit with <code>UIHostingController</code>.
          </p>
    ...
    func updateUIView(_ view: UIPickerView, context: Context) {}
          ...
          <p>
            ...
            <code>@ObservedObject</code>, <code>@StateObject</code> и{' '}
    ...
    var body: some View {
        VStack {
          ...
          <details className={styles.faq} id="faq">
            ...
            <div>
              <p>
                <strong>Подходит ли SwiftUI для сложных экранов?</strong>
                <br />
                Да. Для legacy-кейсов можно избирательно использовать UIKit.
              </p>
              <p>
                <strong>Нужно ли знать UIKit?</strong>
                <br />
                Желательно. Это помогает при интеграциях и тонкой настройке.
              </p>
              <p>
                <strong>Можно ли писать только на SwiftUI?</strong>
                <br />
        ...
        <aside className={styles.author}>
          ...
          <div>
            <h3>Lina</h3>
            <p>
              iOS Engineer & Writer. Любит лаконичный код, читаемые интерфейсы и хорошую
              документацию. Делится опытом миграции на SwiftUI в продакшене.
            </p>
          </div>
        </aside>
