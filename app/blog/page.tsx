...
const featured = {
  ...
  desc: 'Learn what makes SwiftUI a joy to work with: declarative UI, state-driven rendering, and native performance — all in one toolkit.',
  author: 'Themotombana',
...
const related = [
  {
    id: 1,
    title: 'Class adds $30 million to its balance sheet for a Zoom-friendly education app',
    cover:
