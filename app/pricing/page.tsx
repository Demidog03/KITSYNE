...
const features: Record<PlanKey, string[]> = {
  starter: ['AI tutor basic', 'Community access', '5 saved sessions', 'Email support'],
  pro: [
    'AI tutor advanced',
    'Projects & quizzes',
    'Unlimited sessions',
        ...
        <section className={styles.hero}>
          <div className={styles.heroInner}>
            ...
            <p className={styles.subtitle}>
              Start free and upgrade when you’re ready. Simple, transparent pricing for individuals
              and teams.
            </p>
          ...
          <div className={styles.table} role="table" aria-label="Plan comparison">
            ...
            {rows.map((r) => (
              <div className={styles.row} role="row" key={r.key}>
                <div className={`${styles.cell} ${styles.key}`} role="cell">
                  {r.label}
                </div>
        ...
        <section className={styles.faq}>
          ...
          <div className={styles.faqGrid}>
            ...
            <FaqItem q="What’s included in Pro?">
              Advanced AI tutor, unlimited sessions, projects & quizzes, export to PDF/MD and
              priority support.
            </FaqItem>
    ...
    >
      ...
      <div className={styles.priceWrap}>
        ...
        {billing === 'yearly' && price !== 0 && (
          <span className={styles.billingNote}>billed yearly</span>
        )}
      </div>

      <a
        className={`${styles.cardBtn} ${highlight ? styles.cardBtnPrimary : ''}`}
